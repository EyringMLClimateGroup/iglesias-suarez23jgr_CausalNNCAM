...
#SBATCH --job-name=sgl_tphystnd_lat-4_lon-120
#SBATCH --partition=shared
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=LOG.sgl_tphystnd_lat-4_lon-120-%j.o
#SBATCH --error=LOG.sgl_tphystnd_lat-4_lon-120-%j.o
##SBATCH --exclusive
...
logFile=`ls LOG.sgl_tphystnd_lat-4_lon-120-*`
