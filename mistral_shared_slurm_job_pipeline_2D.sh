...
#SBATCH --job-name=sgl_2D_lats_lons14-16
#SBATCH --partition=shared
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=LOG.sgl_2D_lats_lons14-16-%j.o
#SBATCH --error=LOG.sgl_2D_lats_lons14-16-%j.o
##SBATCH --exclusive
...
logFile=`ls LOG.sgl_2D_lats_lons14-16-*`
