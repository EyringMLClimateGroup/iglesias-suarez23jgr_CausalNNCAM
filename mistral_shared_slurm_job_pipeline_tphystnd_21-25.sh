...
#SBATCH --job-name=sgl_tphystnd_21-25_lats_lons21-25
#SBATCH --partition=shared
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=LOG.sgl_tphystnd_21-25_lats_lons21-25-%j.o
#SBATCH --error=LOG.sgl_tphystnd_21-25_lats_lons21-25-%j.o
##SBATCH --exclusive
...
# Scripts
pyScript=pipeline
cfgFile=cfg_${pyScript}_tphystnd_21-25.yml
...
logFile=`ls LOG.sgl_tphystnd_21-25_lats_lons21-25-*`
