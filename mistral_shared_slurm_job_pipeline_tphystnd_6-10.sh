...
#SBATCH --job-name=sgl_tphystnd_6-10_lats_lons14-16
#SBATCH --partition=shared
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=LOG.sgl_tphystnd_6-10_lats_lons14-16-%j.o
#SBATCH --error=LOG.sgl_tphystnd_6-10_lats_lons14-16-%j.o
##SBATCH --exclusive
...
# Scripts
pyScript=pipeline
cfgFile=cfg_${pyScript}_tphystnd_6-10.yml
...
logFile=`ls LOG.sgl_tphystnd_6-10_lats_lons14-16-*`
