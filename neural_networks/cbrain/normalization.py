...
# from .utils import *
import numpy as np
from .cam_constants import C_P, L_S, L_V, DT
...
class InputNormalizer(object):
    ...
    def __init__(self, norm_ds, var_dict, sub="mean", div="std_by_var"):
        var_idxs = return_var_idxs(norm_ds, var_dict)
        ...
        self.transform_arrays = {"sub": self.sub, "div": self.div}
...
class DictNormalizer(object):
    ...
    def __init__(self, norm_ds, var_dict, dic=None):
        if dic is None:
            dic = conversion_dict
        var_idxs = return_var_idxs(norm_ds, var_dict)
