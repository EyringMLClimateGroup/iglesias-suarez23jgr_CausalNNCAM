...
#SBATCH --mem=0
#SBATCH --output=LOG.NN_tb_Rasp_t1-5_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_t1-5_%j.o
#SBATCH --exclusive
...
cfgFile=cfg_NN_Creation_rasp_tphystnd_1-5.yml
...
logFile=`ls LOG.NN_tb_Rasp_t1-5_*`
