...
#SBATCH --mem=0
#SBATCH --output=LOG.NN_tb_Rasp_t6-10_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_t6-10_%j.o
#SBATCH --exclusive
...
cfgFile=cfg_NN_Creation_rasp_tphystnd_6-10.yml
...
logFile=`ls LOG.NN_tb_Rasp_t6-10_*`
