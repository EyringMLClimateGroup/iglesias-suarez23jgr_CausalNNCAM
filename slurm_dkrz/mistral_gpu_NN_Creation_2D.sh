...
#SBATCH --job-name=NN_2D
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --constraint=k80
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_2D_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_2D_%j.o
...
cfgFile=cfg_NN_Creation_rasp_2D.yml
