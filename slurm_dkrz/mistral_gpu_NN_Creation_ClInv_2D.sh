...
#SBATCH --job-name=ClInv2D
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --constraint=k80
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_ClInv2D_%j.o
#SBATCH --error=LOG.NN_tb_ClInv2D_%j.o
...
cfgFile=cfg_NN_Creation_climate_invariant_2D.yml
