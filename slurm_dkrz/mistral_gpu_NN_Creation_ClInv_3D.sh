...
#SBATCH --job-name=ClInv3D
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_ClInv3D_%j.o
#SBATCH --error=LOG.NN_ClInv3D_%j.o
...
cfgFile=cfg_NN_Creation_climate_invariant_3D.yml
