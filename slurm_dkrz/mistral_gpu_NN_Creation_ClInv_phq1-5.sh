...
#SBATCH --job-name=ClInv_q1-5
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_ClInv_q1-5_%j.o
#SBATCH --error=LOG.NN_ClInv_q1-5_%j.o
...
cfgFile=cfg_NN_Creation_climate_invariant_phq_1-5.yml
