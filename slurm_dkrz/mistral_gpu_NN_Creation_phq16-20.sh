...
#SBATCH --job-name=NN_q16-20
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_q16-20_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_q16-20_%j.o
...
cfgFile=cfg_NN_Creation_rasp_phq_16-20.yml
...
logFile=`ls LOG.NN_tb_Rasp_q16-20_*`
