...
#SBATCH --job-name=NN_q21-25
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_q21-25_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_q21-25_%j.o
...
cfgFile=cfg_NN_Creation_rasp_phq_21-25.yml
...
logFile=`ls LOG.NN_tb_Rasp_q21-25_*`
