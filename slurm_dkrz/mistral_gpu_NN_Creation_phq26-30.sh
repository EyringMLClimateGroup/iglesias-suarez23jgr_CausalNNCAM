...
#SBATCH --job-name=NN_q26-30
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_q26-30_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_q26-30_%j.o
...
cfgFile=cfg_NN_Creation_rasp_phq_26-30.yml
...
logFile=`ls LOG.NN_tb_Rasp_q26-30_*`
