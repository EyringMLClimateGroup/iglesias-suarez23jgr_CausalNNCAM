...
#SBATCH --job-name=NN_q6-10
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_q6-10_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_q6-10_%j.o
...
cfgFile=cfg_NN_Creation_rasp_phq_6-10.yml
...
logFile=`ls LOG.NN_tb_Rasp_q6-10_*`
