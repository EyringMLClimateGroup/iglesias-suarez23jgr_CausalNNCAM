...
#SBATCH --job-name=NN_t11-15
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.NN_tb_Rasp_t11-15_%j.o
#SBATCH --error=LOG.NN_tb_Rasp_t11-15_%j.o
...
cfgFile=cfg_NN_Creation_rasp_tphystnd_11-15.yml
...
logFile=`ls LOG.NN_tb_Rasp_t11-15_*`
