...
#SBATCH --job-name=sgl_tphystnd_26-30
#SBATCH --partition=shared
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=LOG.sgl_tphystnd_26-30_%j.o
#SBATCH --error=LOG.sgl_tphystnd_26-30_%j.o
##SBATCH --exclusive
...
# Scripts
pyScript=pipeline
cfgFile=cfg_${pyScript}_tphystnd_26-30.yml
...
logFile=`ls LOG.sgl_tphystnd_26-30_*`
