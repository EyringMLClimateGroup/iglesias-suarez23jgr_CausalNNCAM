...
#SBATCH --job-name=cNN-q103
#SBATCH --partition=prepost
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH --output=LOG.cNN-q103%j.o
#SBATCH --error=LOG.cNN-q103%j.o
...
cfgFile=cfg_causalsinglenns_neural_networks_pnas.yml
