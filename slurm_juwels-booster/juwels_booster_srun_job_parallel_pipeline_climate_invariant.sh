...
#SBATCH --job-name=s3Dt1
#SBATCH --partition=booster
#SBATCH --gres=gpu:4
#SBATCH --nodes=30
#SBATCH --output=LOG.s3Dt1-out_%j
#SBATCH --error=LOG.s3Dt1-out_%j
...
logPath=logs
cfgPath=nn_config
cfgPath_parallel=$cfgPath/climate_invariant_srun_parallel
...
cfgFile_tmp=cfg_pipeline_climate_invariant_srun_parallel.yml
